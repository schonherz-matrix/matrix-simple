...
void MainWindow::sendAnimChanged() {
	emit animChanged(AnimFactory::getAnim(type_, primary_color_, secondary_color_, num_));
}
...
MainWindow::MainWindow(QWidget *parent): QMainWindow{parent} {
	...
	connect(prColorButton, &QPushButton::pressed, this, &MainWindow::selectPrimaryColor);
	connect(scColorButton, &QPushButton::pressed, this, &MainWindow::selectSecondaryColor);
	connect(animComboBox, &QComboBox::currentTextChanged, this, &MainWindow::selectAnim);
	connect(numSpinBox, static_cast<void (QSpinBox::*)(int)>(&QSpinBox::valueChanged), this, &MainWindow::selectNum);
